...
def start_server():
    ...
    try:
        ...
        print(f"[SERVER] Listening on {HOST}:{PORT}")  # Changed to match expected output
        ...
        while True:
            try:
                ...
                if not data:
                    ...
                    print(f"[SERVER] Sent: {reply}")  # Added this line
                
                conn.close()
                print(f"[SERVER] Closed connection")  # Changed to match expected output
